...
//forge script script/GenerateInput.s.sol:GenerateInput -> this command will populate the input.json file
...
contract GenerateInput is Script {
    ...
    function run() public {
        types[0] = "address";
        types[1] = "uint";
        whitelist[0] = "0x6CA6d1e2D5347Bfab1d91e883F1915560e09129D"; // here we can check the address of the created user in the tests when we make it and add via console log check and add the address here and run the scripts to produce input/output files
        whitelist[1] = "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266"; // this is for the anvil chain
